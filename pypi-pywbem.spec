...
Version  : 1.6.1
Release  : 86
URL      : https://files.pythonhosted.org/packages/82/06/8ec1c9213b011132404ea245aed079a6b9c4404300dae32d586810032087/pywbem-1.6.1.tar.gz
...
%prep
%setup -q -n pywbem-1.6.1
cd %{_builddir}/pywbem-1.6.1
pushd ..
cp -a pywbem-1.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678119367
