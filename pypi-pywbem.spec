...
Version  : 1.6.3
Release  : 92
URL      : https://files.pythonhosted.org/packages/32/0a/6f5b38f852a6008610a59174596a810757f30bca165d85c3a85de070118a/pywbem-1.6.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/32/0a/6f5b38f852a6008610a59174596a810757f30bca165d85c3a85de070118a/pywbem-1.6.3.tar.gz
...
%prep
%setup -q -n pywbem-1.6.3
cd %{_builddir}/pywbem-1.6.3
pushd ..
cp -a pywbem-1.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711728145
