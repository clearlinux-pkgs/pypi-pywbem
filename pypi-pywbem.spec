...
Version  : 1.4.1
Release  : 79
URL      : https://files.pythonhosted.org/packages/94/35/e2b23d4b1958839f23ba8494597579146fce4c3031537c38b4abb02b2d41/pywbem-1.4.1.tar.gz
...
%prep
%setup -q -n pywbem-1.4.1
cd %{_builddir}/pywbem-1.4.1
pushd ..
cp -a pywbem-1.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656403232
...
cp %{_builddir}/pywbem-1.4.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-pywbem/caeb68c46fa36651acf592771d09de7937926bb3
