...
Version  : 1.7.2
Release  : 96
URL      : https://files.pythonhosted.org/packages/81/ff/d76820639e22b57ffb76eb7b37d885996fc8f6acd13c3459e89020091d0d/pywbem-1.7.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/81/ff/d76820639e22b57ffb76eb7b37d885996fc8f6acd13c3459e89020091d0d/pywbem-1.7.2.tar.gz
...
%prep
%setup -q -n pywbem-1.7.2
cd %{_builddir}/pywbem-1.7.2
pushd ..
cp -a pywbem-1.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713539304
