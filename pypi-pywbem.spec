...
Version  : 1.6.0
Release  : 85
URL      : https://files.pythonhosted.org/packages/85/c2/a18785f804748534462532c028a182cabdee767a530dcfbbd30560a82d83/pywbem-1.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/85/c2/a18785f804748534462532c028a182cabdee767a530dcfbbd30560a82d83/pywbem-1.6.0.tar.gz
...
%prep
%setup -q -n pywbem-1.6.0
cd %{_builddir}/pywbem-1.6.0
pushd ..
cp -a pywbem-1.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674350549
